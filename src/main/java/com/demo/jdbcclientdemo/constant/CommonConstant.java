...
public class CommonConstant {
    ...
    public static final String SID = "rgf8uwt-euw2prt-wif5llc";
    public static final String TRAN_GROUP = "book";
    public static final String TRAN_CREATE_BOOK = "create_book";
    public static final String TRAN_UPDATE_BOOK = "update_book";
    public static final String TRAN_DELETE_BOOK = "delete_book";
